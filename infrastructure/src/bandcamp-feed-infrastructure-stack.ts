...
export class BandcampFeedInfrastructureStack extends cdk.Stack {
  constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
    ...
    const emailTopicMessageHandler = new lambda.NodejsFunction(this, "ProcessEmailTopicMessage", {
    ...
    const getReleasesHandler = new lambda.NodejsFunction(this, "GetReleasesHandler", {
    ...
    topic.addSubscription(new subscriptions.LambdaSubscription(emailTopicMessageHandler));
